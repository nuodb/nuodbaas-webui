...
export function launchNextBackgroundTask(
  tasks: BackgroundTaskType[],
  setTasks: React.Dispatch<React.SetStateAction<BackgroundTaskType[]>>,
) {
...
export function updateOrAddTask(
  tasks: BackgroundTaskType[],
  setTasks: React.Dispatch<React.SetStateAction<BackgroundTaskType[]>>,
  task: BackgroundTaskType,
) {
...
function BackgroundTasks({ tasks, setTasks, t }: BackgroundTasksProps) {
  ...
  return (
    <details className="NuoBackgroundTasksStatus">
      <summary>{summary}</summary>
      {tasks.map((task) => (
        <div className="NuoRow" key={task.id}>
          {task.showMinimal(task, tasks, setTasks)}
        </div>
      ))}
    </details>
  );
