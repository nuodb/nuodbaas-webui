...
export function filterToWhereClause(
  ...
  Object.keys(filter).forEach((key) => {
    ...
    const convertFunc =
      (isString(sqlType) && oneFilter?.string) ||
      (isNumber(sqlType) && oneFilter?.number) ||
      (isBoolean(sqlType) && oneFilter?.boolean);
            ...
            {columns.map((column, index: number) => (
              <TableRow key={index}>
                ...
                <TableCell>
                  ...
                  >
                    {getFilterConditionOptions(column.type).map((fo) => (
                      <SelectOption value={fo.id}>{fo.label}</SelectOption>
                    ))}
                  </Select>
                </TableCell>
                <TableCell>
