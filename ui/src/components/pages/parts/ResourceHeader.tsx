...
function ResourceHeader({
  ...
  const createLabel = t("button.create.resource", {
    resource: t("resource.label." + pathFirstPart + "_one", pathFirstPart),
  });
  ...
  useEffect(() => {
    ...
    if (pathParts.length >= 4) {
      // ["","projects|databases|backups|backuppolicies|...","{organization}","{project}",...]
  ...
  if (type === "list") {
    ...
    const resourceOne = {
      resources_one: t(
        "resource.label." + pathFirstPart + "_one",
        pathFirstPart,
      ),
    };
        ...
        <Path
          ...
          prefixLabel={
            path.startsWith("/cluster")
              ? t("list.label.cluster")
              : t("list.label.management")
          }
          postfixLabel={postfixLabel}
          filterValues={filterValues}
        />
        <div className="NuoRow" style={{ justifyContent: "end" }}>
          {(type === "not_found" || type === "view") && (
            <div className="Nuo-p20">
              <Button
                data-testid={"create_resource__close_button"}
                variant="text"
                onClick={() => {
                  navigate(-1);
                }}
          ...
          {(type === "create" || type === "edit") && (
            <div className="Nuo-p20">
              <Button
                data-testid={"create_resource__cancel_button"}
                variant="text"
                onClick={() => {
                  navigate(-1);
                }}
          ...
          {type === "list" &&
            createPath &&
            Auth.hasAccess("PUT", createPath, undefined) && (
              <div className="Nuo-p20">
                <Button
                  data-testid={"list_resource__create_button_" + pathFirstPart}
                  variant="contained"
                  onClick={onAction}
                >
                  <AddIcon />
          ...
          {type === "create" &&
            ...
            Auth.hasAccess("PUT", createPath, undefined) && (
              <div className="Nuo-p20">
                <Button
                  data-testid={"create_resource__create_button"}
                  variant="contained"
                  onClick={onAction}
                >
                  <CreateIcon />
          ...
          {type === "edit" && (
            <div className="Nuo-p20">
              <Button
                data-testid={"create_resource__save_button"}
                variant="contained"
                onClick={onAction}
              >
                <SaveIcon />
