...
export default function FieldMap(props: FieldMapProps): ReactNode {
          ...
          <TableCell>
            <TextField
              ...
              value={
                i === valueKeys.length
                  ? ""
                  : getValue(values, prefix)[valueKeys[i]]
              }
              ...
              onBlur={() => {
                return FieldBase_validate({
                  ...
                  parameter:
                    props.parameter["additionalProperties"] || props.parameter,
                });
              }}
            />
          </TableCell>
        ...
        <TableHead>
          <TableRow>
            <TableCell>
              ...
              {t("field.map.header.label.key")}
            </TableCell>
            <TableCell>
              {t("field.label." + prefix, prefix)}{" "}
              {t("field.map.header.label.value")}
            </TableCell>
            <TableCell>
  ...
  function view(): ReactNode {
    ...
    groups.forEach((group) => {
      const groupKeys = Object.keys(value).filter((key) =>
