...
| `nuodbaasWebui.multiInstance.url` | The URL of the Directory Server (returning Multi-Instance data). Ignored if "multiInstanceJson" is set | `` |
| `nuodbaasWebui.multiInstance.json` | JSON content of multi-instance data. If set, it will ignore "multiInstanceUrl" | `` |
